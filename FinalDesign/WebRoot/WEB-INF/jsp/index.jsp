...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <div class="menu">
                    <ul>
						<li><a class="current" href="${pageContext.request.contextPath}/admin_loginPage.action">管理员登录</a></li>
							<li><a class="current" href="${pageContext.request.contextPath}/user_loginPage.action">学生登录</a></li>
...
<table id="rounded-corner" summary="2007 Major IT Companies' Profit">
    ...
    <div class="footer">
    	...
    	<div class="left_footer">Copyright ©2016 BOAN Corporation, All Rights Reserved</div>
